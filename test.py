...
def game_core_tempcat(number):
    ...
    ''' устанавливаем указатель  равным середине  возможного диапазона, а потом уменьшаем или увеличиваем 
        его в зависимости от того, больше оно или меньше загаданного, опираясь на правило,
        что число будет находится в середине предполагаемого диапазона и исходя из предыдущих шагов.
            Функция принимает загаданное число и возвращает число попыток'''
    
    count = 1           # счетчик попыток count
